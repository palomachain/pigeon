...
func (_m *MessageSender) SendMsg(ctx context.Context, msg proto.Message, memo string, opts ...ion.SendMsgOption) (*types.TxResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, proto.Message, string, ...ion.SendMsgOption) (*types.TxResponse, error)); ok {
		return rf(ctx, msg, memo, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, proto.Message, string, ...ion.SendMsgOption) *types.TxResponse); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, proto.Message, string, ...ion.SendMsgOption) error); ok {
