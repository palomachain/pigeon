...
// CompassId provides a mock function with given fields: opts
func (_m *CompassBinding) CompassId(opts *bind.CallOpts) ([32]byte, error) {
	ret := _m.Called(opts)

	if len(ret) == 0 {
		panic("no return value specified for CompassId")
	}
...
// UpdateValset provides a mock function with given fields: opts, consensus, newValset, relayer, gas_estimate
func (_m *CompassBinding) UpdateValset(opts *bind.TransactOpts, consensus compass.Struct2, newValset compass.Struct0, relayer common.Address, gas_estimate *big.Int) (*types.Transaction, error) {
	ret := _m.Called(opts, consensus, newValset, relayer, gas_estimate)
	...
	var r0 *types.Transaction
	var r1 error
	if rf, ok := ret.Get(0).(func(*bind.TransactOpts, compass.Struct2, compass.Struct0, common.Address, *big.Int) (*types.Transaction, error)); ok {
		return rf(opts, consensus, newValset, relayer, gas_estimate)
	}
	if rf, ok := ret.Get(0).(func(*bind.TransactOpts, compass.Struct2, compass.Struct0, common.Address, *big.Int) *types.Transaction); ok {
		r0 = rf(opts, consensus, newValset, relayer, gas_estimate)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.Transaction)
		}
	...
	if rf, ok := ret.Get(1).(func(*bind.TransactOpts, compass.Struct2, compass.Struct0, common.Address, *big.Int) error); ok {
		r1 = rf(opts, consensus, newValset, relayer, gas_estimate)
	} else {
		r1 = ret.Error(1)
	}
