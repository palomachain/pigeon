...
// newMockEthClienter creates a new instance of mockEthClienter. It also registers a cleanup function to assert the mocks expectations.
func newMockEthClienter(t testing.TB) *mockEthClienter {
