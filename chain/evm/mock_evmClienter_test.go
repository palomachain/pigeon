...
// ExecuteSmartContract provides a mock function with given fields: ctx, chainID, contractAbi, addr, opts, method, arguments
func (_m *mockEvmClienter) ExecuteSmartContract(ctx context.Context, chainID *big.Int, contractAbi abi.ABI, addr common.Address, opts callOptions, method string, arguments []interface{}) (*types.Transaction, error) {
	ret := _m.Called(ctx, chainID, contractAbi, addr, opts, method, arguments)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *big.Int, abi.ABI, common.Address, callOptions, string, []interface{}) (*types.Transaction, error)); ok {
		return rf(ctx, chainID, contractAbi, addr, opts, method, arguments)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *big.Int, abi.ABI, common.Address, callOptions, string, []interface{}) *types.Transaction); ok {
		r0 = rf(ctx, chainID, contractAbi, addr, opts, method, arguments)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *big.Int, abi.ABI, common.Address, callOptions, string, []interface{}) error); ok {
		r1 = rf(ctx, chainID, contractAbi, addr, opts, method, arguments)
	} else {
		r1 = ret.Error(1)
	}
