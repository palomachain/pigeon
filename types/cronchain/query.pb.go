...
type Validator struct {
	...
	State              ValidatorState       `protobuf:"varint,3,opt,name=state,proto3,enum=volumefi.cronchain.consensus.ValidatorState" json:"state,omitempty"`
...
func init() {
	proto.RegisterEnum("volumefi.cronchain.consensus.ValidatorState", ValidatorState_name, ValidatorState_value)
	...
	proto.RegisterType((*QueryValidatorInfoRequest)(nil), "volumefi.cronchain.consensus.QueryValidatorInfoRequest")
	proto.RegisterType((*QueryValidatorInfoResponse)(nil), "volumefi.cronchain.consensus.QueryValidatorInfoResponse")
	proto.RegisterType((*Validator)(nil), "volumefi.cronchain.consensus.Validator")
	proto.RegisterType((*ExternalChainInfo)(nil), "volumefi.cronchain.consensus.ExternalChainInfo")
}
...
var fileDescriptor_e104e1a2c4ac5aa2 = []byte{
	...
	,
}
...
func (c *queryValsetClient) ValidatorInfo(ctx context.Context, in *QueryValidatorInfoRequest, opts ...grpc.CallOption) (*QueryValidatorInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/volumefi.cronchain.consensus.QueryValset/ValidatorInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _QueryValset_ValidatorInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/volumefi.cronchain.consensus.QueryValset/ValidatorInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _QueryValset_serviceDesc = grpc.ServiceDesc{
	ServiceName: "volumefi.cronchain.consensus.QueryValset",
