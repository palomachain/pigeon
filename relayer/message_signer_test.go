...
func TestSignMessages(t *testing.T) {
	...
	testcases := []struct {
		...
		},
		{
			...
			setup: func(t *testing.T) *Relayer {
				...
				p.On("SignMessages", mock.Anything, mock.Anything, mock.Anything).Return(nil, nil)
				...
				pal.On("BroadcastMessageSignatures", mock.Anything, mock.Anything).Return(nil)
	...
	for _, tt := range testcases {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			actualErr := relayer.SignMessages(ctx, &locker)
