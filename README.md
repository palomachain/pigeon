...
```shell
wget -O - https://github.com/palomachain/pigeon/releases/download/v0.3.0-alpha/pigeon_0.3.0-alpha_Linux_x86_64v3.tar.gz | \
tar -C /usr/local/bin -xvzf - pigeon
chmod +x /usr/local/bin/pigeon
mkdir ~/.pigeon
```

If you're upgrading to the most recent version, you will need to stop `pigeond` before copying the new binary into place.
