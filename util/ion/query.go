...
func (cc *Client) queryBalanceWithAddress(ctx context.Context, address string) (sdk.Coins, error) {
...
// TODO add pagination support
func (cc *Client) queryDenomTraces(ctx context.Context, offset, limit uint64, height int64) ([]transfertypes.DenomTrace, error) {
